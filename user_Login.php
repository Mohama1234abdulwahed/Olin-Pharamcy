    ...
    <div class="login-box">
      ...
      <form action="" method="post"> 
        ...
        <div class="signup-link">
          <a href="http://localhost/demo/admin-erea/user-erea/user_registration.php">Signup</a>
        </div>
    ...
    if ($row_count > 0) {
        ...
        if (password_verify($user_password, $row['user_password'])) {
            ...
            if ($row_count == 1) {
                ...
                echo '<script>
                document.write(\'<div class="alert alert-primary" role="alert">login successful!</div>\');
                alert(\'Login successful\');
              </script>';
              echo '<script>window.open("/demo/profile.php", "_self")</script>';
            } else {
                $_SESSION['username'] = $user_username;
