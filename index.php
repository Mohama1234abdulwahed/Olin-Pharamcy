...
?>
  ...
  <ul class="nav-item">
         <a class='nav-link active' href="admin_login.php">Management..</a>
</nav>
 <!-- 3child-->

 <div class="site-blocks-cover d-flex align-items-center" style="background-image: url('web.jpg'); height: 100vh;">
  <div class="container">
    <div class="row">
      <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
        <div class="site-block-cover-content text-center">
          ...
          <p>
            <a href="#shop" class="btn btn-info px-1 py-1">Shop Now</a>
          </p>
        </div>
      </div>
    </div>
...
<div class="row">
    ...
    <ul class="navbar-nav me-auto text-center">
        ...
        <ul class="navbar-nav me-auto text-center">
            <li class="nav-item bg-info">
                <a href="#" class="nav-link text-light"><h1>Brands</h1></a>
            </li>
            <?php
            getbrands();
            ?>
